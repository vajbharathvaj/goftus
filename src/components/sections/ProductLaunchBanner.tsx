...
export function ProductLaunchBanner({
  product = "Flagen AI",
  // ⬇️ Use the external URL by default
  href = "https://flaggen.ai/",
              ...
              <div className="flex items-center gap-2 md:gap-3">
                ...
                >
                  <span className="pointer-events-none absolute inset-0 overflow-hidden rounded-full">
                    <span className="absolute -left-[120%] top-0 h-full w-[120%] bg-gradient-to-r from-transparent via-white/35 to-transparent opacity-20 blur-[2px] animate-[shine_2.6s_linear_infinite]" />
                  </span>
                  Try {product} →
                </a>

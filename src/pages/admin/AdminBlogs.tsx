      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-white md:text-4xl">Blog Posts</h1>
          </div>
        ...
        {loading ? (
          <div className="mt-8 rounded-3xl border border-white/10 bg-white/5 p-8 text-slate-300">
            Loading posts...
          </div>
        ) : posts.length === 0 ? (
          <div className="mt-8 rounded-3xl border border-white/10 bg-white/5 p-8 text-slate-300">
        ...
        {canManageAdmins && (
          <div className="mt-12 grid gap-6 rounded-3xl border border-white/10 bg-white/5 p-6">
            <div>
